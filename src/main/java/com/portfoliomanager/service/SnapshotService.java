...
/**
 * Records a daily snapshot of the consolidated portfolio value so the customer can see
 * a performance chart over time, and rolls today's value into "previous value" so that
